...
\begin{tikzpicture}[
    node distance=1.5cm,
    repo/.style={rectangle, draw, fill=green!20, text width=2cm, text centered, minimum height=1cm, font=\footnotesize},
    argo/.style={rectangle, draw, fill=blue!20, text width=2.5cm, text centered, minimum height=1cm, font=\footnotesize},
    k8s/.style={rectangle, draw, fill=orange!20, text width=2cm, text centered, minimum height=1cm, font=\footnotesize},
    arrow/.style={->, thick, blue}
]
